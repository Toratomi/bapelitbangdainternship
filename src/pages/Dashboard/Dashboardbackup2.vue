  ...
  <v-container fluid>
    <div class="dashboard-page">
      <v-row no-gutters class="d-flex justify-space-between mt-10 mb-6">
        ...
        <div v-for="job in jobs" :key="job.id" class="dashboard-page">
...
export default {
  ...
  data() {
    return {
      ...
      mainApexAreaSelect: "Daily",
      jobs: [
        {tittle : 'test job 1', id: 1, details: 'lorem'},
        {tittle : 'test job 2', id: 2, details: 'lorem'},
        {tittle : 'test job 3', id: 3, details: 'lorem'},
      ]
    };
  },
  methods: {
